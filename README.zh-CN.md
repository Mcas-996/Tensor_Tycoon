...
| 💳 | **信用贷款** | 每笔获得 5,000 点数，十轮后自动偿还，并可在清算时抵押或拍卖资产。 |
...
- **贷款**每笔提供 5,000 点数，并在十轮后偿还；同轮到期贷款会合并扣款，未偿本金不再从净资产中扣除。
- **贷款清算**允许释放 Tensor、抵押或拍卖未抵押模型；资产拍卖会连同已有 Tensor 转移，也可以主动破产。
